"""
Transaction Matcher - Primary Application File
Combines core processing logic with GUI interface
"""
import sys
import os
import csv
...
def process_fee_matching():
    """Original console version - calls GUI version with hardcoded paths"""
